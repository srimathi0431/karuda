...
export default function AdminLayout({ children }) {
  ...
  const menuItems = [
    ...
    { path: '/admin/bank-details', icon: Landmark, label: 'Bank Details' },
    { path: '/admin/tracking', icon: Package, label: 'Product Tracking' },
    { path: '/admin/bonus', icon: Gift, label: 'Bonus / Tracking' },
    { path: '/admin/wallets-management', icon: CreditCard, label: 'Wallets Management' },
    { path: '/admin/withdrawals', icon: CreditCard, label: 'Withdrawals' },
    { path: '/admin/withdrawal-settings', icon: Package, label: 'Withdrawal Settings' },
    { path: '/admin/award-claims', icon: Gift, label: 'Award Claims' },
    { path: '/admin/bonus-reports', icon: LayoutDashboard, label: 'Bonus Reports' },
    { path: '/admin/achievements', icon: Gift, label: 'Achievements' },
    { path: '/admin/binary-tree', icon: Users, label: 'Binary Tree' },
  ];
